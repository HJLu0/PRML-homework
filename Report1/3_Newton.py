...
plt.plot(x_line, y_line, color='#f39c12', linewidth=3, label='拟合曲线')

plt.legend(fontsize=12)
plt.grid(alpha=0.3)
plt.title("牛顿法", fontsize=14)
plt.savefig("牛顿法.png", dpi=300, bbox_inches='tight')
plt.close()
